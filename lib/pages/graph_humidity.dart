...
class DetailHumid extends StatefulWidget {
  const DetailHumid({Key? key}) : super(key: key);

  @override
  State<DetailHumid> createState() => _DetailHumidState();
}
...
class _DetailHumidState extends State<DetailHumid> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 16),
              Text(
                'Rata-rata Humidity dan Tanggal',
                style: TextStyle(
                  fontSize: 18,
                              ...
                              TableRow(
                                children: [
                                  TableCell(
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(item['humidity'].toString()),
                                    ),
                                  ),
                                  TableCell(
                                    child: Padding(
